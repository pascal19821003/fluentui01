...
export default function PosterApp(props: Partial<MenuProps>) {
    ...
    return (
        <>
            <Avatar color={"brand"} initials={"BR"} name={"Brand Color avatar"} /> brand            
            <Avatar color={"beige"} initials={"BR"} name={"Brand Color avatar"} /> beige            
            <Avatar color={"gold"} initials={"BR"} name={"Brand Color avatar"} /> gold            
        </>
